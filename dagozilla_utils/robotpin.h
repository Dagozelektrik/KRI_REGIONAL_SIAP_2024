...
MotorDagoz locomotionMotorFR(LOCOMOTION_PWM_PERIOD_US, PF_12, PH_1, PF_8); //Locomotion Front Right Motor PF_8
MotorDagoz locomotionMotorBL(LOCOMOTION_PWM_PERIOD_US, PG_1, PF_3, PF_9);  //Locomotion Back Left Motor PF_9
MotorDagoz locomotionMotorBR(LOCOMOTION_PWM_PERIOD_US, PC_2, PF_4, PD_15); //Locomotion Back Right Motor PD_15
