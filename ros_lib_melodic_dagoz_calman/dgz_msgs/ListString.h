#ifndef _ROS_dgz_msgs_ListString_h
#define _ROS_dgz_msgs_ListString_h
...
namespace dgz_msgs
{
  ...
  class ListString : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "dgz_msgs/ListString"; };
