#ifndef _ROS_dgz_msgs_PairStringString_h
#define _ROS_dgz_msgs_PairStringString_h
...
namespace dgz_msgs
{
  ...
  class PairStringString : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "dgz_msgs/PairStringString"; };
