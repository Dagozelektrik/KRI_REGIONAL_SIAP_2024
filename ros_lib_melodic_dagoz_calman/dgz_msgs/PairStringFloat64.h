#ifndef _ROS_dgz_msgs_PairStringFloat64_h
#define _ROS_dgz_msgs_PairStringFloat64_h
...
namespace dgz_msgs
{
  ...
  class PairStringFloat64 : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "dgz_msgs/PairStringFloat64"; };
    virtual const char * getMD5() override { return "61479750a8a2da2e629a5d4755c0076b"; };
